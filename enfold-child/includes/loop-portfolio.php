...
if ($q_event->have_posts()) :
    ...
    if($loop_counter>3 || $loop_counter==1)
        {
              $extra = 'first';
              $loop_counter =1;
        } else {
...
?>
        ...
        <article class='flex_column av_one_third post-entry port-item post-entry-type-page slide-parity-<?php echo $total; ?> <?php echo $post_class; echo ' '.$extra; ?>' <?php avia_markup_helper(array('context' => 'entry')); ?>>
